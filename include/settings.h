...
#define SOFTWARE_VERSION_STRING "TIICT 2024-11-14"
...
#define NUM_CAL_VARIABLES 18
#define NUM_EXPORT_VARIABLES 40

#define MAX_NUMBER_OF_FITINFO_BITS_PER_COMPONENT 8
#define GSL_FIT_MAXIMUM_ITERATIONS 500
#define DETREND_MODEL_FIT_DEGREE 2 // linear model: 2; cubic model: 3

#define LP_MIN_NUMBER_OF_POTENTIALS 160000

#define DEFAULT_PLOT_HEIGHT 55
